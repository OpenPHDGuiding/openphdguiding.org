...
![Log upload Step 1](assets/logupload_1.png){ width="75%" }
...
![Log upload Step 2](assets/logupload_2.png){ width="75%" }

Confirm and click Upload

![Log upload Step 3](assets/logupload_3.png){ width="75%" }

Copy the link to the clipboard

![Log upload Step 4](assets/logupload_4.png){ width="75%" }
