...
!!! tip
    ...
    We recommend running the latest [development snapshot build](development-snapshots.md) to get the latest bug fixes and enhancements. The development builds are updated more frequently than the general releases below.
...
- New option for enabling/disable audible beep for lost star
